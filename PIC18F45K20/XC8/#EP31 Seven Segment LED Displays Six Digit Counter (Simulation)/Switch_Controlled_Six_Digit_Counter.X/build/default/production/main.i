...
# 33 "main.c"
unsigned char RAM;
unsigned char First_Digit,Second_Digit,Third_Digit,Fourth_Digit,Fifth_Digit,Sixth_Digit;
...
void main(void)
{
    ...
    while(1){
        while(Counter<=999999){
                ...
                _delay((unsigned long)((75)*(20000000/4000.0)));

                Second_Digit = (Counter % 100)/10;
                RAM = PORTD;
                PORTD = Second_Digit | (RAM&=0xF0) ;
                LATCbits.LATC6 = !1;
                LATCbits.LATC7 = !1;
                LATDbits.LATD4 = !1;
                LATDbits.LATD5 = !1;
                ...
                Fourth_Digit = (Counter /1000)%10;
                RAM = PORTD;
                PORTD = Fourth_Digit | (RAM&=0xF0);
                LATCbits.LATC6 = !1;
                LATCbits.LATC7 = !1;
                LATDbits.LATD4 = 1;
                LATDbits.LATD5 = !1;
                ...
                Fifth_Digit = (Counter / 10000) %10;
                RAM = PORTD;
                PORTD = Fifth_Digit | (RAM&=0xF0);
                LATCbits.LATC6 = !1;
                LATCbits.LATC7 = 1;
                LATDbits.LATD4 = !1;
                LATDbits.LATD5 = !1;
                ...
                Sixth_Digit = Counter / 100000;
                RAM = PORTD;
                PORTD = Sixth_Digit | (RAM&=0xF0);
                LATCbits.LATC6 = 1;
                LATCbits.LATC7 = !1;
                LATDbits.LATD4 = !1;
                LATDbits.LATD5 = !1;
