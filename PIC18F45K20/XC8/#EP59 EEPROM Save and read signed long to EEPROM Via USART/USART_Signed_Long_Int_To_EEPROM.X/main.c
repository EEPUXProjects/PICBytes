/* Exercise : USART Signed Long Int To EEPROM
 * Author : Usmaan H  
 * Version : 1.0
 * Description : In this exercise we will be able to save a signed long integer value into the EEPROM via the serial terminal. 
                 Then be able to read it back and see it as it was typed in.
...
void main(void)
{
    ...
    USART_String_Receive(ASCII_Conversion,11); // Enter up to 11 digits with zeros filling in unused integers. E.g value 23. Enter 00000000023.
