...
void servoRotate0()
{
  ...
  for(i=0;i<50;i++)
  {
    ...
    LATBbits.LATB0 = 0;
    _delay((unsigned long)((19200)*(500000/4000000.0)));
  }
}
...
void servoRotate90()
{
  ...
  {
    LATBbits.LATB0 = 1;
    _delay((unsigned long)((1500)*(500000/4000000.0)));
    LATBbits.LATB0 = 0;
    _delay((unsigned long)((18500)*(500000/4000000.0)));
  }
}
...
void servoRotate180()
{
  ...
  {
    LATBbits.LATB0 = 1;
    _delay((unsigned long)((2200)*(500000/4000000.0)));
    LATBbits.LATB0 = 0;
    _delay((unsigned long)((17800)*(500000/4000000.0)));
  }
}
