...
unsigned int Pan_MAP ;
unsigned int Tilt_MAP;
...
ADC_Result_1 = ADC_GetConversion(1);
Pan_MAP = map(ADC_Result_1, 0, 1023, 31, 63);
PWM2_LoadDutyValue(Pan_MAP );
sprintf(xvalueASCII,"%s%d%s","Pan Value : ",Pan_MAP,"\r\n");
SendUsartString(xvalueASCII);
_delay((unsigned long)((1000)*(500000/4000.0)));
ADC_Result_2 = ADC_GetConversion(0);
Tilt_MAP = map(ADC_Result_2, 0, 1023, 31, 63);
EPWM1_LoadDutyValue(Tilt_MAP );
