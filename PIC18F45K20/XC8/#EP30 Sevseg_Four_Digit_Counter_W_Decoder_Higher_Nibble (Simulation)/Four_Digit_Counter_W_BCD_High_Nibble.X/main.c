/* Exercise : Four Digit Multiplexed Seven Segment Display Counter With a BCD Decoder On High Nibble.
 * Author : Usmaan H 
 * Version : 1.0
 ...
 * with a 7447 decoder on the ports higher nibble.
 */
...
// Initialize the device
    ...
    while (1)
    {
        ...
        {   // Count Up if Switch Number 1 is pressed.
            ...
            First_Digit = ((Counter % 100)%10)<<4; // Retrieve Lowest Digit , Shift Value to Higher Nibble and Save in First_Digit
            RAM = Display_Port; // Save Display Port value into RAM
            Display_Port =  First_Digit | (RAM&=0x0F) ;//Clear Higher Nibble Of Variable RAM and Add Value of First Digit To RAM.
            ...
            Second_Digit = ((Counter % 100)/10)<<4; // Retrieve 2nd Lowest Digit , Shift Value to Higher Nibble and Save in Second_Digit
            RAM = Display_Port; // Save Display Port value into RAM
            Display_Port =  Second_Digit | (RAM&=0x0F) ; //Clear Higher Nibble Of Variable RAM and Add Value of Second Digit To RAM.
            ...
            Third_Digit = ((Counter % 1000)/100)<<4; // Retrieve Third Lowest Digit , Shift Value to Higher Nibble and Save in Third_Digit
            RAM = Display_Port; // Save Display Port value into RAM
            Display_Port =  Third_Digit | (RAM&=0x0F); //Clear Higher Nibble Of Variable RAM and Add Value of Third Digit To RAM.                
            Digit_1 = !Active; // Disable Digit.
            Digit_2 = !Active; // Disable Digit.
            ...
            Fourth_Digit = (Counter / 1000)<<4; // Retrieve Highest Digit , Shift Value to Higher Nibble and Save in Fourth_Digit
            RAM = Display_Port; // Save Display Port value into RAM
            Display_Port =  Fourth_Digit | (RAM&=0x0F);  //Clear Higher Nibble Of Variable RAM and Add Value of Fourth Digit To RAM.
            Digit_1 = !Active; // Disable Digit.
            Digit_2 = !Active; // Disable Digit.
            Digit_3 = !Active; // Disable Digit.
