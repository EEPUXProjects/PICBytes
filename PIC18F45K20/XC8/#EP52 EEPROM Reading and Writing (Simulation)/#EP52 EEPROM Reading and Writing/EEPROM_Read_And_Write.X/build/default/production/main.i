...
void main(void)
{
    ...
    DATAEE_WriteByte(0x01,0xFF);
    DATAEE_WriteByte(0x02,0xF0);
    DATAEE_WriteByte(0x03,0x0F);
    _delay((unsigned long)((10)*(20000000/4000.0)));

    RAM = DATAEE_ReadByte(0x01);
    LATB = RAM;
    _delay((unsigned long)((500)*(20000000/4000.0)));

    RAM = DATAEE_ReadByte(0x02);
    LATB = RAM;
    _delay((unsigned long)((500)*(20000000/4000.0)));

    RAM = DATAEE_ReadByte(0x03);
    LATB = RAM;
    _delay((unsigned long)((500)*(20000000/4000.0)));
