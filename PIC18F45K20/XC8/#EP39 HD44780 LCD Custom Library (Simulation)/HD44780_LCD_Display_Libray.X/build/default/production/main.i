...
void main(void)
{
    ...
    Configure_LCD();
    LCD_Write_Message(1,4,"Custom LCD ");
    LCD_Write_Message(2,5,"Library");
    LCD_Write_Message(3,3,"Welcome !!!");
    LCD_Write_Custom_Chararacter(0,Happyface);
    LCD_Read_Custom_Chararacter(0,4, 8);
    while(1);
}
