...
void LCD_Write_Message(char row,char pos,const char *msg)
{
    ...
    switch(row)
    {
        case 1: location=0x80;
        break;

        case 2: location=0xC0;
        break;

        case 3: location=0x90;
        break;

        case 4: location=0xD0;
        break;

    }

    LCD_Command((location) | ((pos) & 0x0f));
    ...
    if(Location<8)
    {
     LCD_Command(0x40+(Location*8));
       for(int Counter=0;Counter<8;Counter++)
           LCD_Write_Data(Message[Counter]);
...
void LCD_Read_Custom_Chararacter(unsigned char Character_Address, unsigned char row , unsigned char pos)
{
    ...
    LCD_Write_Data(Character_Address);
}
