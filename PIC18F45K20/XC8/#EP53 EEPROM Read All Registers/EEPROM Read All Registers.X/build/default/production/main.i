...
void main(void)
{
    ...
    for (int Current_Address = 0x00 ; Current_Address <= 0xFF; Current_Address++)
    {
        sprintf(ASCII_Conversion,"%s %u %s %u","\r\n Address ", Current_Address,": ",DATAEE_ReadByte(Current_Address) );
        USART_String_Transmit(ASCII_Conversion);
