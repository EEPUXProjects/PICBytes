...
void main(void)
{
    ...
    while(1){
        ...
        Calculated_result =(4450/(float)(ADC_Result_1)-1);                                   //Calculate distance of object with 3V3 supply to PIC.
        //Calculated_result =(2914/(float)(ADC_Result_1)-1);                                   //Calculate distance of object with 5V supply to PIC.
