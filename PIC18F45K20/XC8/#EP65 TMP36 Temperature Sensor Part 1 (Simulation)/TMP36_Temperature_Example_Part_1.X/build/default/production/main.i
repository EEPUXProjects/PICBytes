...
void main(void)
{
    ...
    { ADC_SelectChannel(0);
        ...
        UART_Positive_Negative_Tempreture_Output();
        Seven_Segment_Positive_Tempreture_Output();
    }
}
...
{
    whole = TMP36_Reading;
    decimal=(TMP36_Reading-whole)*1000;
    sprintf(xvalueASCII,"%s%3d.%01d%s","Temperature : ",whole,decimal, " Degrees \n\r " );
    USART_String_Transmit(xvalueASCII);
